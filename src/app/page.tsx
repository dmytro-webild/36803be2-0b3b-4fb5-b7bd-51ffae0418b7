    ...
    >
      ...
      <div id="hero" data-section="hero">
        <HeroSplitDoubleCarousel
          title="Donde el vermú sabe mejor"
      ...
      <div id="menu" data-section="menu">
        <ProductCardTwo
          ...
          products={[
            {
              id: "1",              brand: "🍷",              name: "Vermú Clásico",              price: "5€",              rating: 5,
              reviewCount: "150+",              imageSrc: "http://img.b2bpic.net/free-photo/glass-with-fruity-drink-tray_23-2148667939.jpg?id=10073271",              imageAlt: "Vermú Clásico"
            },
            {
